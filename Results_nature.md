...
We combined the four independent variables into a nomogram (Fig. 5). The Rad-score carries the greatest weight, spanning the full 0 to 100 point range over its observed interval of −4 to 0.5. Fibrinogen contributes up to approximately 55 points on a descending scale, and tuberculosis and BAA approximately 23 and 21 points when present. Total scores range from 0 to 180.
